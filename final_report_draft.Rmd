...
```{r handgun/rifle model output 2, warning=FALSE, echo=FALSE,message=FALSE, out.width = "50%"}
require(devtools)
require(jagstools)
...
```{r, warning='hide', results='hide', warning=FALSE, echo=FALSE,message=FALSE,out.width = "50%"}
require(loo)
...
```{r logistic model: handgun vs shotgun, results='hide', echo=FALSE,message=FALSE, warning =FALSE}
model <- "
model  {
  for (i in 1:n){
    shotgun[i] ~ dbern(p[i])
...
```{r handgun/shotgun model output, echo=FALSE,message=FALSE, warning=FALSE,out.width = "50%"}
require(devtools)
require(jagstools)
...
```{r handgun/rifle model output, echo=FALSE,message=FALSE,out.width = "50%"}
...
```{r, warning='hide', results='hide', echo=FALSE,message=FALSE,out.width = "50%"}
require(loo)
